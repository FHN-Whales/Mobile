...
// import { KeyboardAvoidingView, Platform, TouchableWithoutFeedback, View, Image, Text, TextInput, TouchableOpacity, Modal, ActivityIndicator, Alert } from 'react-native';
// import register from '../../../styles/FamilyManagement/Register/RegisterScreen';
// import { Formik } from 'formik';
// import SignupSchema from '../../../hook/FamilyManagement/Register/useValidateRegister';
// import useRegister from '../../../hook/FamilyManagement/Register/useRegister';
...
//   const [accountExists, setAccountExists] = useState(false); // State để lưu trạng thái thông báo

//   // Function to handle form submission
//   const handleSubmit = async (values) => {
//     setLoading(true); // Set loading state to true while waiting for response
//     try {
//       const response = await mutationRegisterUser.mutate(values);
//       if (response && response.error === 'account_exists') {
//         Alert.alert('Email already exists', 'An account with this email already exists. Please use a different email.');
//       } else {
//         // Registration was successful
//         setModalVisible(true); // Show success modal or perform other actions
//       }
//     } catch (error) {
...
//             </TouchableOpacity>
//           </TouchableWithoutFeedback>
//           {/* Display the account exists message if the state is true */}
//           {accountExists && (
//             <Text style={register.textError}>* An account with this email already exists.</Text>
//           )}
//           {/* Display loading indicator */}
//           {loading && (
//             <View style={register.loadingContainer}>
//               <ActivityIndicator size="large" color="#87CEFA" />
//             </View>
//           )}
//         </KeyboardAvoidingView>
