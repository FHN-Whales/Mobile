  ...
  const data: Item[] = [
    {
      ...
      reminder: 'Nhớ phải đi sớm và đúng giờ ',
    },
  ];
  return (
    <FlatList
        ...
        <View style={renderhealthscheduling.container}>
          <View style={rendertiltereminder.container}>
            ...
            <View style={renderhealthscheduling.viewSession}>
              ...
              <Text style={renderhealthscheduling.textSession}>
                {item.session}
              </Text>
              <TouchableOpacity>
            ...
            <View style={renderhealthscheduling.viewMedicine}>
              ...
              <Text style={renderhealthscheduling.textMedicineName}>
                {item.doctor}
              </Text>
            </View>
            <View style={renderhealthscheduling.viewMedicine}>
              <Text style={renderhealthscheduling.textMedicine}>
                Re-examination date :
              </Text>
              <Text style={renderhealthscheduling.textMedicineName}>
                {item.re_examination_date}
              </Text>
            </View>
            <View style={renderhealthscheduling.viewMedicine}>
              <Text style={renderhealthscheduling.textMedicine}>
